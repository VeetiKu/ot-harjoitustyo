...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_summan_lataus_ei_muuta_saloda(self):
        self.kortti.lataa_rahaa(-500)
        self.assertEqual(self.kortti.saldo_euroina(), 10.0)
    
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_kortin_saldo_250(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        
        self.assertEqual(kortti.saldo_euroina(), 0.0)
        
    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_kortin_saldo_400(self):
